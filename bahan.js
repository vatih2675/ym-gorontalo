...
const bahan = [
    {
        ...
        jenisProduk: [
                ...
                rincian: [
                    {
                        ...
                        contoh:"Es batu untuk dijual (dikonsumsi publik), es mambo, es stik, es buah, es puter, es lilin, es kue, sorbet, sherbet, es serut, es campur, es berperisa, es mengandung susu, es rasa susu"
                    },
                ],
                kbli: [
                    "10531 Industri pengolahan es krim",
                ...
                rincian: [
                    {
                        ...
                        contoh:"Asinan buah, rujak buah, manisan buah, cincau hijau olahan, cincau hitam, keripik buah, dodol buah, wajit buah"
                    },
                    {
                        namaBahan:"4.2 Sayur, rumput laut, kacang dan biji-bijian segar yang dilakukan pengolahan dan diberikan bahan tambahan pangan",
                        contoh:"Kuaci, emping melinjo, selai kacang, pasta tomat, kimchi, keripik bayam, keripik jamur, getuk singkong"
                    },
                ],
                kbli: [
            ...
            },
            {
                ...
                rincian: [
                    {
                        namaBahan:"5.1 Produk kakao dan cokelat termasuk produk pengganti cokelat",
                        contoh:"Bubuk minuman cokelat, praline, cokelat isi"
                    },
                    {
                        namaBahan:"5.2 Kembang gula/permen meliputi kembang gula keras dan lunak/permen keras dan lunak, nougats, dan lain-lain",
                        contoh:"Gula kapas, gulali, permen enting-enting"
                    },
                    {
                        namaBahan:"5.3 Gula dekorasi",
                        contoh:"Saus / topping / olesan cokelat, Saus / topping / olesan manis"
                    },
                ],
                kbli: [
            ...
            },
            {
                ...
                rincian: [
                    ...
                    {
                        namaBahan:"6.2 Tepung dan pati dengan penambahan bahan tambahan pangan",
                        contoh:"Tepung beras dengan penambahan BTP, tepung beras. Ketan dengan penambahan BTP, tepung kacang hijau dengan penambahan BTP, tapioka"
                    },
                    {
                    ...
                    {
                        namaBahan:"6.4 Pasta dan mie serta produk sejenisnya (misalnya rice paper, vermiseli beras / bihun, pasta kedelai dan mi kedelai)",
                        contoh:"Mie basah mentah, kulit pangsit / risol / lumpia / siomay / dimsum, produk mie sayur, kerupuk mentah"
                    },
                    {
                        namaBahan:"6.5 Makanan pencuci mulut berbasis serealia dan pati (misalnya tepung puding nasi, tepung puding tapioka)",
                        contoh:"Sagu / pati mutiara"
                    },
                    {
                        namaBahan:"6.6 Tepung untuk adonan (misalnya untuk melapisi permukaan ikan atau daging ayam)",
            ...
            },
            {
                ...
                rincian: [
                    ...
                    {
                        namaBahan:"7.3 Kue basah/semi basah berbahan dasar beras dan lainnya",
                        contoh:""
                    },
                    {
            ...
            },
            {
                ...
                rincian: [
                    {
                        namaBahan:"8.1 Moluska, krustase, dan ekinodermata, yang telah mengalami pengolahan",
                        contoh:"Kerupuk ikan, sambal goreng ikan, pempek ikan, terasi ikan, abon ikan, siomay ikan"
                    },
                    {
                        namaBahan:"8.2 Ikan dan produk perikanan termasuk moluska, krustase dan ekinodermata yang semi awet",
            ...
            },
            {
                ...
                rincian: [
                    ...
                    {
                        namaBahan:"9.2 Telur yang diawetkan, termasuk produk tradisional telur yang diawetkan, termasuk dengan cara dibasakan, diasinkan dan dikalengkan",
            ...
            },
            {
                ...
                rincian: [
                    ...
                    {
                        namaBahan:"10.2 Gula dan sirup lainnya (missal xilosa, sirup, maple, gula hias)",
            ...
            },
            {
                ...
                rincian: [
                    {
                        namaBahan:"12.1 Makanan olahan berbahan dasar kentang, umbi, serealia, tepung atau pati",
                        contoh:"Kerupuk beras, rengginang, rempeyek"
                    },
                    {
                        namaBahan:"12.2 Olahan kacang, termasuk kacang terlapisi  dan campuran kacang dengan buah kering",
        ...
        jenisProduk: [
            {
                ...
                rincian: [
                    ...
                    {
                        namaBahan:"1.3 Minuman berbasis air, berperisa, dan particulated drinks",
                        contoh:"Minuman jeli, minuman sari buah"
                    },
                    {
                        namaBahan:"1.4 Kopi, kopi substitusi, teh, seduhan herbal, dan minuman biji- bijian dan sereal panas, kecuali cokelat",
                        contoh:"Minuman serbuk kopi, kopi bubuk, minuman sari kacang hijau."
                    },
                    {
...
const divJenisMakannan = document.querySelector("#divJenisMakanan");
let contentJenisMakanan = "";
bahan.forEach(bhn => {
    contentJenisMakanan += `<div class="w-full rounded-xl shadow-md overflow-hidden bg-purple-200 text-purple-600">
                                <h1 class="p-2 sm:p-4 text-center font-bold shadow-md uppercase">${bhn.produk}</h1>
                                <div class="p-2 sm:p-4">
                                    <table class="w-full">
                                        <thead>
                                            <tr class="bg-purple-300">
                                                <th class="p-1 sm:p-2 border border-purple-400 w-2/12">JENIS PRODUK</th>
                                                <th class="p-1 sm:p-2 border border-purple-400 w-5/12">RINCIAN</th>
                                                <th class="p-1 sm:p-2 border border-purple-400 w-5/12">KBLI</th>
                                            </tr>
                                        </thead>
                                        <tbody>`;
    bhn.jenisProduk.forEach(jp => {
        contentJenisMakanan += `<tr>
                                    <td class="align-top p-1 sm:p-2 border border-purple-400">
                                        <p>${jp.nama}</p>
                                        <p class="mt-2">${jp.catatan}</p>
                                    </td>
                                    <td class="align-top p-1 sm:p-2 border border-purple-400">`;
        jp.rincian.forEach(rcn => {
            contentJenisMakanan += `<p class="font-bold">${rcn.namaBahan}</p>
                                    <p class="italic mb-3">${rcn.contoh}</p>`;
        });
        contentJenisMakanan += `</td>
                                    <td class="align-top p-1 sm:p-2 border border-purple-400">
                                        <ol class="list-disc ms-3 sm:ms-5">`;
        for (let i = 0; i < jp.kbli.length; i++) {
            contentJenisMakanan += `<li>${jp.kbli[i]}</li>`;
        }
        contentJenisMakanan += `</ol>
                                    </td>
                                </tr>`;
    });
    contentJenisMakanan += `</tbody>
                        </table>
                    </div>
                </div>`;
});

divJenisMakannan.innerHTML = contentJenisMakanan;
